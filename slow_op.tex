...
%For the Floquet case, we can find the optimal single site Hermitian operator from which we can construct a filtered operator
%that matches the exact results. Therefore, we omit the results of another set of paramt
