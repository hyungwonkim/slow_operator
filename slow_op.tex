...
\label{fig:mpo}
\end{figure}
To extend to larger systems, we use a matrix product method.  In this case, we consider operators in the space spanned by $U^n \hat{O} U^{-n}$ for $\hat{O}$ a
traceless hermitian operator acting on a single site. 
