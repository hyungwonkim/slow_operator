...
\begin{figure}
\includegraphics[width=1.0\linewidth]{figures/semi_infinite_full_optimal.pdf}
\centering
...
\begin{figure}
\includegraphics[width=1.00\linewidth]{figures/Hamiltonian_only.pdf}
\centering
...
\begin{figure}
\includegraphics[width=1.0\linewidth]{figures/semi_infinite_floquet_only.pdf}
\centering
...
\begin{figure}
\includegraphics[width=1.0\linewidth]{figures/semi_infinite_full_optimal_other_parameter.pdf}
\centering
...
\begin{figure}
\includegraphics[width=1.0\linewidth]{figures/X_Z_ZZ_only_two_parameters.pdf}
\centering
...
\begin{figure}
\includegraphics[width=1.0\linewidth]{figures/semi_infinite_floquet_two_parameters_extended.pdf}
\centering
